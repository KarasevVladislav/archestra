...
export const TOOL_CONVERT_CONVERSATION_TO_SCHEDULED_TASK_SHORT_NAME =
...
export const TOOL_CONVERT_CONVERSATION_TO_SCHEDULED_TASK_FULL_NAME =
  `${ARCHESTRA_TOOL_PREFIX}${TOOL_CONVERT_CONVERSATION_TO_SCHEDULED_TASK_SHORT_NAME}` as const;
