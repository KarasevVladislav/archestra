...
/**
 * Delete an Internal MCP catalog item by slug
 */
export const deleteInternalMcpCatalogItemBySlug = <ThrowOnError extends boolean = false>(options: Options<DeleteInternalMcpCatalogItemBySlugData, ThrowOnError>) => (options.client ?? client).delete<DeleteInternalMcpCatalogItemBySlugResponses, DeleteInternalMcpCatalogItemBySlugErrors, ThrowOnError>({ url: '/api/internal_mcp_catalog/by-slug/{slug}', ...options });
